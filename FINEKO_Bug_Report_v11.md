...
**Опис:**  
Зараз об'єкт бота містить тільки `id`, `name`, `slug`, `project`. Немає можливості зберегти опис воронки — що вона робить, яка мета, що отримує студент на виході. Те ж саме для нод — є тільки `label`.
