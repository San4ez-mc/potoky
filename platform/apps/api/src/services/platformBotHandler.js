...
// Урок 2026-08-29: перший ліміт (90с) виявився ЗАНАДТО туго натягнутим — реальний
// "план на місяць" (диспетчер → ST:Generate батчами → гуманайзер → bulk-import)
// легально займає ~90-120с і сам спрацював таймаут на власному тесті. Підняв до
// 180с — досить для одного великого батча, і досі рятує від справжнього зависання.
const CHAT_LOCK_TIMEOUT_MS = 180000;
