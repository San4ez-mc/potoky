...
- payMethod: «1», «часткова», «наложка/накладений/при отриманні», «200» → cod; «2», «повна», «повністю», «зараз всю суму», «вся сума» → full. Просто «передоплата»/«предоплата»/«по передоплаті» БЕЗ цифри чи слів «повна/вся сума/200» — НЕОДНОЗНАЧНО (може бути і 200 грн, і повна): payMethod null (бот перепитає 1 чи 2). Питання «а можна накладеним?» без вибору → payMethod null + questions.
