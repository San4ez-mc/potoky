...
1. Якщо ПІДКАЗКА НЕ порожня — привітайся у тон клієнта і перелічи ці товари РІВНО як у підказці, кожен рядок дослівно зі словом «Артикул …» (артикул, назва, ціна; нічого не змінюй і не додавай), потім спитай: «Який цікавить? Напишіть артикул або скиньте пост 😊».
