...
const SIZE_FIRST_MSG_RE = '\\d{2,3}\\s*[\\/,\\s\\-]\\s*\\d{2,3}|зр[іо]ст|ріст|ваг[аи]|\\bсм\\b|\\bкг\\b|розмір|размер|\\b(xs|s|m|l|xl|xxl|xxxl|2xl|3xl)\\b|\\b(хс|м|л|хл|ххл)\\b(?!\\.)|наявн|є ще|актуальн|залишил|окрем|отдельн|доставк|обмін|поверн|приміря|наклад|післяплат|передоплат|предоплат|оплат';
