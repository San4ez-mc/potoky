...
ok('V8b', 'n_avail_cond[true] → (фото допродажу один раз) → n_order_intent', branch('n_avail_cond', 'true') === 'n_upsell_photo_cond' && branch('n_upsell_photo_cond', 'true') === 'n_upsell_photo' && branch('n_upsell_photo_cond', 'false') === 'n_order_intent' && next('n_upsell_photo') === 'n_upsell_photo_mark' && next('n_upsell_photo_mark') === 'n_order_intent' && /ДОПРОДАЖ/.test(byId.n_order_intent.data.systemPrompt));
