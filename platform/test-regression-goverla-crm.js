...
ok('V5b', 'n_unknown_msg: категорії, підказка, довідка у промпті; n_catalog_hint віддає catalogCategories', /catalogCategories/.test(byId.n_unknown_msg.data.systemPrompt) && /SHOP_FAQ/.test(byId.n_unknown_msg.data.systemPrompt) && /catalogCategories/.test(byId.n_catalog_hint.data.code));
