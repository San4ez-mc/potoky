...
(async () => {
    ...
    ok('B-V9e', 'n_order_prefill: повторне замовлення в сесії → попереднє в prevOrders, orderRef/crmOrderId/оплата скинуті, адреса лишається', x.prevOrders && x.prevOrders[0].crmOrderId === 'old-1' && x.crmOrderId === null && x.orderRef === null && x.payStatus === null && x.orderData === undefined, JSON.stringify(x));
